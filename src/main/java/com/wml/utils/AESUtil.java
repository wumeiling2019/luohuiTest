...
public class AESUtil {
    ...
    public static String CIPHER_KEY = "889970da95be0d87f9c5426798e643d6";
    ...
    public static void  main(String args[]) throws Exception{
        String content = "15000678549";
        String encCode = AESEncode(content, CIPHER_KEY);
        System.out.println(encCode);
        System.out.println(AESDecode(encCode, CIPHER_KEY));
    }
}
